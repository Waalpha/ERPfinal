  ...
  return (
    <div className="space-y-6 max-w-2xl bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
      <div className="flex items-center space-x-2 text-indigo-600 mb-1">
        ...
        <h2 className="text-lg font-black text-slate-900">Retail Store Settings</h2>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          type="submit"
          className="px-4 py-2 bg-indigo-600 text-white text-xs font-semibold rounded-xl hover:bg-indigo-500 flex items-center space-x-1"
        >
